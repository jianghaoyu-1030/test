...
#
# DMA_BRAM.tcl: Tcl script for re-creating project 'DMA_BRAM'
#
# Generated by Vivado on Tue Jul 26 22:37:06 +0800 2022
...
#
# 1. This project restoration tcl script (DMA_BRAM.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "F:/jiang/worked_project/DMA_UDP_BRAM/DMA_BRAM.srcs/sources_1/bd/system/system.bd"
#    "F:/jiang/worked_project/DMA_UDP_BRAM/DMA_BRAM.srcs/sources_1/imports/Desktop/bram.v"
#    "F:/jiang/worked_project/DMA_UDP_BRAM/DMA_BRAM.srcs/sources_1/imports/v/data_test.v"
#    "F:/jiang/worked_project/DMA_UDP_BRAM/DMA_BRAM.srcs/sources_1/bd/system/hdl/system_wrapper.v"
#    "F:/jiang/worked_project/DMA_UDP_BRAM/DMA_BRAM.srcs/sources_1/new/top.v"
#    "F:/jiang/worked_project/DMA_UDP_BRAM/DMA_BRAM.srcs/sources_1/ip/ila_0/ila_0.xci"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../../DMA_UDP_BRAM"]"

# Create project 设置工程路径
create_project ${_xil_proj_name_} ./work -part xc7z020clg484-2
...
set files [list \
 [file normalize "${origin_dir}/src/hdl/bram.v"]\
 [file normalize "${origin_dir}/src/hdl/data_test.v"]\
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/../../DMA_UDP_BRAM/DMA_BRAM.srcs/sources_1/ip/ila_0/ila_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg484-2 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z020clg484-2 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
