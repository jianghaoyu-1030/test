...
proc create_root_design { parentCell } {
  ...
  set gpio_bram [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_bram ]
  set gpio_dma [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 gpio_dma ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets BRAM_PORTB_0_1] [get_bd_intf_ports BRAM_PORTB] [get_bd_intf_pins system_ila_1/SLOT_0_BRAM]
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets BRAM_PORTB_0_1]
...
set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets S_AXIS_0_1]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports gpio_dma] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports gpio_bram] [get_bd_intf_pins axi_gpio_0/GPIO2]
